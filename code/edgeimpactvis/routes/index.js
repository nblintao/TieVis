...
// Connection URL
var url = 'mongodb://localhost:27018/edgeImpactVis';
...
router.get('/queryByIdxs', function(req, res) {
    ...
    if(!isNaN(compID) && compID !== undefined) {
        mongoose.connection.db.collection("vis.graph.componentNew", function(err, comp) {
        ...
        mongoose.connection.db.collection("vis.graph.componentNew", function(err, edges) {
...
router.get('/query', function(req, res) {
    ...
    if(input.indexOf(",") === -1) {
        ...
        mongoose.connection.db.collection("vis.graph.edgeList", function(err, edges) {
...
router.get('/flow', function(req, res) {
    ...
    var direct = req.query.direct;
    mongoose.connection.db.collection("vis.graph.impactNew", function (err, impact) {
