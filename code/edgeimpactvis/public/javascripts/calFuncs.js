            ...
            var biCoor = biData.map(function(d) {
                ...
                for(var i = 0; i < 2; i++) {
                    for(var j = 0; j < levelSum[i].length; j++) {
                        ...
                        axis[i].data.push({
                            x0:pos[i],
                            x1:pos[i] + xScale(levelSum[i][j].length),
                            y:i==0?yt:yb - axisHeight,
                            edges:levelSum[i][j],
                            time:year
                        });
                        pos[i] += xScale(levelSum[i][j].length);
                    }
                }
                for(var i = 0, len = d.data.length; i < len; i++) {
                ...
                for (var y = 0; y < years.length; y++) {
                    ...
                    for (var v = 0; v < values.length; v++) {
                        ...
                        for (var j = 0; j < data[value].length; j++) {
                            ...
                            if(data[value][j].edge === "13315_36436") {
                                console.log(value);
                            }
                            if(nodes[0] === nodes[1]) {
                                continue;
...
//                            edgeData[data[value][j].edge].push({
//                                key:years[y] + "_" + level,
//                                pairNum:data[value][j].pairNum
//                            });
...
//                        var count = 0;
//                        timescale().forEach(function(t) {
//                            if(occurrence[t] !== undefined && occurrence[t] === 2) {
//                                count += 1;
//                            }
//                        });
//                        var value = count / timescale().length;
